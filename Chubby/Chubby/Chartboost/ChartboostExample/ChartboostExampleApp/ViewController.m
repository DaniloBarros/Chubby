...
- (IBAction)sendPIALevelTracking:(id)sender {
    ...
    NSString *eventLabel = @"Mario's character level";
    NSString *eventDescription = @"Mario's highest level";
...
- (NSString*)stringForCBLevelType:(CBLevelType)levelType {
    if (levelType == HIGHEST_LEVEL_REACHED) {
        return @"Level Type - HIGHEST_LEVEL_REACHED";
    } else if (levelType == CURRENT_AREA) {
        return @"Level Type - CURRENT_AREA";
    } else if (levelType == OTHER_NONSEQUENTIAL) {
        return @"Level Type - OTHER_NONSEQUENTIAL";
    } else if (levelType == OTHER_SEQUENTIAL) {
        return @"Level Type - OTHER_SEQUENTIAL";
    } else {
        return @"Level Type - CHARACTER_LEVEL";
    }
}
